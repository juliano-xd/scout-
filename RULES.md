...
* **Política de Commit Automático:** Toda modificação bem-sucedida, que for validada por 100% dos testes unitários e de integração, DEVE ser comitada no controle de versão (Git) imediatamente após a validação.
